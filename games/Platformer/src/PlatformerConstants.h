...
namespace PlatformerConstants
{
    ...
    static constexpr float PLAYER_WALL_JUMP_LOCK_TIME = 0.27f; // Time during which the player is locked in a wall jump
    ...
    static constexpr float PLAYER_WALL_JUMP_ANGLE = 60.0f; // Angle of wall jump in degrees (0 = pure sideways, 90 = pure up)
